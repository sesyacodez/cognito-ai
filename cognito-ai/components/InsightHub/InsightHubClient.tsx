...
import { normalizeJourney } from "@/utils/journeyHelpers";
import { timeAgo, groupJourneysByDate } from "@/utils/dateFormatting";
import { SidebarGroup } from "./SidebarGroup";

export default function InsightHubClient() {
  ...
  const groups = groupJourneysByDate(journeys);
