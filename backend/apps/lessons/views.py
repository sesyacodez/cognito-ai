...
from utils.lesson_state import calculate_stars, calculate_xp, safe_transition_status
from utils.lesson_stub_store import get_lesson, save_lesson
from utils.progress_store import get_lesson_progress, update_lesson_progress


_DEFAULT_USER = "anonymous"


def _get_legacy_user_id(request) -> str:
